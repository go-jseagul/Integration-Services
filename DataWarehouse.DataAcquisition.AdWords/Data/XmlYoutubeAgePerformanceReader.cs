...
{
    public class XmlYoutubeAgePerformanceReader : XmlReportSqlBulkCopyDataReader
    {
        public override string DestinationTable
        {
            get { return "[raw].[ytAgePerformanceReport]"; }
        }
                ...
                this._values = new object[]
                    {
                        ...
                        (string)row.Attribute("ageRangeState"),
